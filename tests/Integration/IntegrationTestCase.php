...
abstract class IntegrationTestCase extends KernelTestCase
{
     ...
     * to describe.
     *
     * SchemaTool::dropSchema() emits a DROP per MAPPED table and swallows a
     * statement that fails, so anything the mapping does not know about
     * survives; if it holds a foreign key, the drop it blocks is swallowed
     * too and the next createSchema() collides with a table that was supposed
     * to be gone. Read from the catalogue and dropped with CASCADE instead. A
     * table an EXTENSION owns is left alone — pg_depend.deptype = 'e' marks
